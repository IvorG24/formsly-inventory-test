...
import { InventoryEmployeeList, InventoryListType } from "@/utils/types";
import {
  ActionIcon,
  Anchor,
  CopyButton,
...
import { FilterSelectedValuesType } from "./EventFilterByPersonFilter";
...
type Props = {
  ...
  employee: InventoryEmployeeList | null;
...
export default EventFilterByPersonTable;
