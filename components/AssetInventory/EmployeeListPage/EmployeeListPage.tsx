  ...
  return (
    <Container fluid>
      {/* <UpdateModal
        ...
        type="site"
      /> */}
      <EmployeeDrawer isOpen={opened} close={close} />
          ...
          columns={[
            {
              ...
              title: "HRIS ID",
              render: (employee) => (
                <Text>{employee.scic_employee_hris_id_number}</Text>
              ),
            },
            {
              ...
              title: "First Name",
              render: (employee) => (
                <Text>{employee.scic_employee_first_name}</Text>
              ),
            },
            {
              ...
              title: "Middle Name",
              render: (employee) => (
                <Text>{employee.scic_employee_middle_name}</Text>
              ),
            },
            {
              ...
              title: "Last Name",
              render: (employee) => (
                <Text>{employee.scic_employee_last_name}</Text>
              ),
            },
            {
              ...
              title: "Suffix",
              render: (employee) => (
                <Text>{employee.scic_employee_suffix}</Text>
              ),
            },
            {
              accessor: "site_name",
              width: "10%",
              title: "Site",
              render: (employee) => <Text>{employee.site_name}</Text>,
            },
            {
              accessor: "location_name",
              width: "15%",
              title: "Location",
              render: (employee) => <Text>{employee.location_name}</Text>,
            },
            {
              accessor: "team_department_name",
              width: "15%",
              title: "Department",
              render: (employee) => (
                <Text>{employee.team_department_name}</Text>
              ),
            },
          ]}
        />
