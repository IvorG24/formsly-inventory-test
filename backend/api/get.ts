...
export const getEventDetails = async (
  ...
  const { data, error } = await supabaseClient.rpc("get_event_details", {
    input_data: params,
  });
...
export const getSiteList = async (
  ...
  const { search, page, limit, teamid, isAScendingSort, columnAccessor } =
    params;
  ...
  if (isAScendingSort && columnAccessor) {
...
export const getColumnListDynamic = async (
  supabaseClient: SupabaseClient<Database>,
  params: {
    formId?: string;
    type?: string;
...
export const getEventFormDetails = async (
  supabaseClient: SupabaseClient<Database>,
...
export const getDynamicReportView = async (
  supabaseClient: SupabaseClient<Database>,
  params: {
    limit?: number;
    page?: number;
...
export const getColumnFieldsEvent = async (
  ...
  const { data, error } = await supabaseClient.rpc("get_column_fields_event", {
    input_data: params,
  });
...
export const getAssignedCount = async (
  ...
  const { data, error } = await supabaseClient.rpc("get_assigned_asset_count", {
    input_data: params,
  });
