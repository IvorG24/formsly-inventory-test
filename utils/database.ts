    ...
    Tables: {
      ...
      inventory_event_table: {
        Row: {
          ...
          inventory_event_signature: string | null
        }
        Insert: {
          inventory_event?: string | null
          inventory_event_date_created?: string | null
      ...
      inventory_request_table: {
        Row: {
          ...
          inventory_request_date_updated: string
          inventory_request_department: string | null
          ...
          inventory_request_site: string | null
