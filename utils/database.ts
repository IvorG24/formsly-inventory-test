  ...
  form_schema: {
    Tables: {
      ...
      questionnaire_table: {
        ...
        Relationships: [
          {
            foreignKeyName: "questionnaire_table_questionnaire_created_by_fkey"
            columns: ["questionnaire_created_by"]
            isOneToOne: false
            referencedRelation: "team_member_table"
            referencedColumns: ["team_member_id"]
          },
          {
            foreignKeyName: "questionnaire_table_questionnaire_team_id_fkey"
            columns: ["questionnaire_team_id"]
            isOneToOne: false
            referencedRelation: "team_table"
            referencedColumns: ["team_id"]
          },
          {
            foreignKeyName: "questionnaire_table_questionnaire_updated_by_fkey"
            columns: ["questionnaire_updated_by"]
            isOneToOne: false
            referencedRelation: "team_member_table"
            referencedColumns: ["team_member_id"]
          },
  ...
  hr_schema: {
    Tables: {
      ...
      hr_project_table: {
        ...
        Relationships: [
          {
            foreignKeyName: "hr_project_table_hr_project_address_id_fkey"
            columns: ["hr_project_address_id"]
            isOneToOne: false
      ...
      recruitment_table: {
        ...
        Relationships: [
          {
            foreignKeyName: "recruitment_table_recruitment_request_id_fkey"
          ...
          {
            foreignKeyName: "recruitment_table_recruitment_team_member_id_fkey"
            columns: ["recruitment_team_member_id"]
            isOneToOne: false
            referencedRelation: "team_member_table"
            referencedColumns: ["team_member_id"]
          },
  ...
  inventory_request_schema: {
    Tables: {
      inventory_assignee_table: {
        Row: {
          inventory_assignee_asset_request_id: string
          inventory_assignee_id: string
          inventory_assignee_site_id: string | null
          inventory_assignee_team_member_id: string | null
        }
        Insert: {
          inventory_assignee_asset_request_id: string
          inventory_assignee_id?: string
        ...
        Relationships: [
          {
            foreignKeyName: "inventory_assignee_table_inventory_assignee_asset_request__fkey"
            columns: ["inventory_assignee_asset_request_id"]
            isOneToOne: false
            referencedRelation: "inventory_request_table"
            referencedColumns: ["inventory_request_id"]
          },
          {
            foreignKeyName: "inventory_assignee_table_inventory_assignee_site_id_fkey"
            columns: ["inventory_assignee_site_id"]
            isOneToOne: false
      ...
      inventory_custom_response_table: {
        Row: {
          inventory_response_asset_request_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "inventory_custom_response_tab_inventory_response_asset_req_fkey"
            columns: ["inventory_response_asset_request_id"]
            isOneToOne: false
            referencedRelation: "inventory_request_table"
            referencedColumns: ["inventory_request_id"]
          },
          {
            foreignKeyName: "inventory_custom_response_tabl_inventory_response_field_id_fkey"
            columns: ["inventory_response_field_id"]
            isOneToOne: false
            referencedRelation: "field_table"
            referencedColumns: ["field_id"]
          },
      ...
      inventory_event_table: {
        Row: {
          inventory_event: string | null
          inventory_event_check_out_date: string | null
          inventory_event_date_created: string | null
          inventory_event_due_date: string | null
          inventory_event_id: string
          inventory_event_notes: string | null
          inventory_event_request_id: string
          inventory_event_return_date: string | null
        }
        Insert: {
          inventory_event?: string | null
          inventory_event_check_out_date?: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "inventory_event_table_inventory_event_request_id_fkey"
            columns: ["inventory_event_request_id"]
            isOneToOne: false
            referencedRelation: "inventory_request_table"
            referencedColumns: ["inventory_request_id"]
          },
      ...
      inventory_history_table: {
        Row: {
          ...
          inventory_history_returned_to: string | null
        }
        Insert: {
          inventory_history_action_by: string
          inventory_history_assigneed_to?: string | null
      ...
      inventory_request_table: {
        Row: {
          ...
          inventory_request_form_id: string
          inventory_request_id: string
          inventory_request_item_code: string
          inventory_request_location: string
        ...
        Relationships: [
          {
            foreignKeyName: "inventory_request_table_inventory_request_form_id_fkey"
            columns: ["inventory_request_form_id"]
            isOneToOne: false
  ...
  inventory_schema: {
    Tables: {
      ...
      custom_field_table: {
        ...
        Relationships: [
          {
            foreignKeyName: "custom_field_table_category_option_id_fkey"
            columns: ["category_option_id"]
            isOneToOne: false
            referencedRelation: "option_table"
      ...
      field_table: {
        Row: {
          ...
          field_is_disabled: boolean | null
          field_is_read_only: boolean
          field_is_required: boolean
      ...
      sub_category_table: {
        ...
        Relationships: [
          {
            foreignKeyName: "sub_category_table_sub_category_id_fkey"
          ...
          {
            foreignKeyName: "sub_category_table_sub_field_id_fkey"
  ...
  lookup_schema: {
    Tables: {
      ...
      position_table: {
        ...
        Relationships: [
          {
            foreignKeyName: "position_table_position_questionnaire_id_fkey"
            columns: ["position_questionnaire_id"]
            isOneToOne: false
            referencedRelation: "questionnaire_table"
            referencedColumns: ["questionnaire_id"]
          },
