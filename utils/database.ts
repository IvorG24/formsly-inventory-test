...
export type Database = {
  ...
  inventory_request_schema: {
    Tables: {
      inventory_assignee_table: {
        Row: {
          inventory_assignee_customer_id: string | null
          inventory_assignee_employee_id: string | null
          inventory_assignee_id: string
          inventory_assignee_request_id: string
          inventory_assignee_site_id: string | null
        }
        Insert: {
          inventory_assignee_customer_id?: string | null
          inventory_assignee_employee_id?: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "inventory_assignee_table_inventory_assignee_request_id_fkey"
            columns: ["inventory_assignee_request_id"]
            isOneToOne: true
            referencedRelation: "inventory_request_table"
            referencedColumns: ["inventory_request_id"]
          },
        ]
      }
      inventory_custom_response_table: {
        Row: {
          inventory_response_field_id: string | null
          inventory_response_id: string
          inventory_response_request_id: string
          inventory_response_value: string
        }
        Insert: {
          inventory_response_field_id?: string | null
          inventory_response_id?: string
      ...
      inventory_history_table: {
        Row: {
          ...
          inventory_history_field: string | null
          inventory_history_id: string
          inventory_history_request_id: string
        }
        Insert: {
          inventory_history_action_by: string
          inventory_history_changed_from?: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "inventory_history_table_inventory_history_request_id_fkey"
            columns: ["inventory_history_request_id"]
            isOneToOne: false
            referencedRelation: "inventory_request_table"
            referencedColumns: ["inventory_request_id"]
          },
      ...
      inventory_maintenance_table: {
        Row: {
          inventory_maintenance_by: string | null
          inventory_maintenance_completion_date: string
          inventory_maintenance_cost: number | null
          inventory_maintenance_date_created: string
          inventory_maintenance_details: string | null
          inventory_maintenance_id: string
          inventory_maintenance_request_id: string
          inventory_maintenance_status: string
          inventory_maintenance_title: string
        }
        Insert: {
          inventory_maintenance_by?: string | null
          inventory_maintenance_completion_date: string
        ...
        Relationships: [
          {
            foreignKeyName: "inventory_maintenance_table_inventory_maintenance_request__fkey"
            columns: ["inventory_maintenance_request_id"]
            isOneToOne: false
            referencedRelation: "inventory_request_table"
            referencedColumns: ["inventory_request_id"]
          },
      ...
      inventory_relationship_table: {
        ...
        Relationships: [
          {
            foreignKeyName: "inventory_relationship_table_child_asset_id_fkey"
          ...
          {
            foreignKeyName: "inventory_relationship_table_parent_asset_id_fkey"
      ...
      inventory_request_table: {
        Row: {
          inventory_request_brand: string
          inventory_request_category: string
          inventory_request_cost: number
          inventory_request_created: string
          inventory_request_created_by: string
          inventory_request_csi_code: string
          inventory_request_department: string
          inventory_request_description: string
          inventory_request_equipment_type: string
          inventory_request_id: string
          inventory_request_image_url: string | null
          inventory_request_location: string | null
          inventory_request_model: string
          inventory_request_name: string
          inventory_request_old_asset_number: string | null
          inventory_request_purchase_date: string
          inventory_request_purchase_from: string
          inventory_request_purchase_order: string
          inventory_request_serial_number: string
          inventory_request_si_number: string
          inventory_request_site: string
          inventory_request_status: string
          inventory_request_sub_category: string | null
          inventory_request_tag_id: number
          inventory_request_team_id: string
        }
        Insert: {
          inventory_request_brand: string
          inventory_request_category: string
      ...
      inventory_warranty_table: {
        Row: {
          inventory_warranty_date_created: string
          inventory_warranty_expiration_date: string
          inventory_warranty_id: string
          inventory_warranty_length: number | null
          inventory_warranty_notes: string | null
          inventory_warranty_request_id: string
          inventory_warranty_status: string
        }
        Insert: {
          inventory_warranty_date_created?: string
          inventory_warranty_expiration_date: string
        ...
        Relationships: [
          {
            foreignKeyName: "inventory_warranty_table_inventory_warranty_request_id_fkey"
            columns: ["inventory_warranty_request_id"]
            isOneToOne: false
            referencedRelation: "inventory_request_table"
            referencedColumns: ["inventory_request_id"]
          },
  ...
  inventory_schema: {
    Tables: {
      category_table: {
        Row: {
          category_id: string
          category_is_disabled: boolean | null
      ...
      custom_field_table: {
        ...
        Relationships: [
          {
            foreignKeyName: "custom_field_table_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "custom_field_table_custom_field_id_fkey"
      ...
      event_form_connection_table: {
        Row: {
          event_form_event_id: string
          event_form_form_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "event_form_connection_table_event_form_event_id_fkey"
            columns: ["event_form_event_id"]
            isOneToOne: false
            referencedRelation: "inventory_event_table"
            referencedColumns: ["event_id"]
          },
          {
            foreignKeyName: "event_form_connection_table_event_form_form_id_fkey"
            columns: ["event_form_form_id"]
            isOneToOne: false
            referencedRelation: "inventory_form_table"
            referencedColumns: ["form_id"]
          },
        ]
      }
      ...
      inventory_employee_connection_table: {
        Row: {
          inventory_employee_connection_date_created: string
          inventory_employee_connection_department_id: string
          inventory_employee_connection_employee_id: string
          inventory_employee_connection_id: string
          inventory_employee_connection_location_id: string | null
          inventory_employee_connection_site_id: string
        }
        Insert: {
          inventory_employee_connection_date_created?: string
          inventory_employee_connection_department_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "inventory_employee_connectio_inventory_employee_connectio_fkey1"
            columns: ["inventory_employee_connection_location_id"]
            isOneToOne: false
            referencedRelation: "location_table"
            referencedColumns: ["location_id"]
          },
          {
            foreignKeyName: "inventory_employee_connection_inventory_employee_connectio_fkey"
            columns: ["inventory_employee_connection_site_id"]
            isOneToOne: false
            referencedRelation: "site_table"
      ...
      inventory_event_table: {
        Row: {
          ...
          event_id: string
          event_is_custom_event: boolean
          event_is_disabled: boolean
          event_name: string
          event_status: string
      ...
      inventory_group_filter_table: {
        Row: {
          inventory_group_filter_type: string
          inventory_group_filter_value_id: string
          inventory_group_id: string
          inventory_group_ilter_id: string
        }
        Insert: {
          inventory_group_filter_type: string
          inventory_group_filter_value_id: string
      ...
      inventory_group_permissions_table: {
        Row: {
          inventory_group_id: string
          inventory_group_permission_id: string
          inventory_permission_id: string
          inventory_permission_value: boolean
        }
        Insert: {
          inventory_group_id: string
          inventory_group_permission_id?: string
        ...
        Relationships: [
          {
            foreignKeyName: "inventory_group_permissions_table_inventory_permission_id_fkey"
            columns: ["inventory_permission_id"]
            isOneToOne: false
            referencedRelation: "inventory_permissions_table"
            referencedColumns: ["inventory_permission_id"]
          },
        ]
      }
      inventory_permissions_table: {
        Row: {
          inventory_permission_id: string
          inventory_permission_key: string
          inventory_permission_label: string
        }
        Insert: {
          inventory_permission_id?: string
          inventory_permission_key: string
      ...
      location_table: {
        ...
        Relationships: [
          {
            foreignKeyName: "location_table_location_site_id_fkey"
      ...
      sub_category_table: {
        Row: {
          sub_category_category_id: string
          sub_category_id: string
          sub_category_is_disabled: boolean | null
        ...
        Relationships: [
          {
            foreignKeyName: "sub_category_table_sub_category_category_id_fkey"
            columns: ["sub_category_category_id"]
            isOneToOne: false
            referencedRelation: "category_table"
            referencedColumns: ["category_id"]
          },
  ...
  public: {
    ...
    Functions: {
      ...
      get_asset_event_report_on_load: {
        Args: {
          input_data: Json
        }
        Returns: Json
      ...
      get_custom_field_details_on_load: {
        Args: {
          input_data: Json
        }
        Returns: Json
